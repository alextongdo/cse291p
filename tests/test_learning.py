...
def test_ieee_simple():
    ...
    expected_constraints = {
        ...
        # "LinearConstraint(root.height = 17/8 * search.height + 0)",
        "LinearConstraint(root.height = 69/2 * topbar.height + 0)",
        "LinearConstraint(root.height = 35 * topbar.height + 0)",
        ...
        # "LinearConstraint(author2.height = 301)",
        "LinearConstraint(author3.height = 300)",
        # "LinearConstraint(author3.height = 301)",
        "LinearConstraint(authors.height = 435)",
        "LinearConstraint(root.height = 870)",
        ...
        # "LinearConstraint(author1.top = 1 * author2.top + -1)",
        ...
        # "LinearConstraint(author2.right = 1 * author3.left + -29)",
        "LinearConstraint(author2.top = 1 * author1.top + 0)",
        "LinearConstraint(author2.top = 1 * author3.top + 0)",
        # "LinearConstraint(author2.top = 1 * author3.top + 1)",
        ...
        # "LinearConstraint(authors.bottom = 1 * author1.bottom + 31)",
        ...
        "LinearConstraint(authors.center_y = 1 * author1.center_y + -38)",
        "LinearConstraint(authors.center_y = 1 * author1.center_y + -37)",
        "LinearConstraint(authors.center_y = 1 * author2.center_y + -38)",
        "LinearConstraint(authors.center_y = 1 * author2.center_y + -37)",
        "LinearConstraint(authors.center_y = 1 * author3.center_y + -38)",
        "LinearConstraint(authors.center_y = 1 * author3.center_y + -37)",
        ...
        # "LinearConstraint(authors.right = 1 * search.right + 1)",
        ...
        # "LinearConstraint(root.bottom = 1 * authors.bottom + -1)",
        "LinearConstraint(root.bottom = 1 * authors.bottom + 0)",
        "LinearConstraint(root.center_x = 1 * authors.center_x + 0)",
        # "LinearConstraint(root.center_x = 1 * search.center_x + -1)",
        "LinearConstraint(root.center_x = 1 * search.center_x + 0)",
        "LinearConstraint(root.center_x = 1 * topbar.center_x + 0)",
        "LinearConstraint(root.center_y = 1 * authors.center_y + -218)",
        "LinearConstraint(root.center_y = 1 * authors.center_y + -217)",
        "LinearConstraint(root.center_y = 1 * topbar.center_y + 422)",
        "LinearConstraint(root.center_y = 1 * topbar.center_y + 423)",
        ...
        # "LinearConstraint(root.top = 1 * topbar.top + 1)",
