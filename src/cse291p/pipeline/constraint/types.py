"""Constraint types (ConstraintKind, IConstraint, Priority).

Reimplements:
- mockdown/src/mockdown/constraint/types.py (lines 1-261)
"""
...
class IComparisonOp(Protocol[T]):
    """Comparison operator protocol.
    
    Reimplements: mockdown/src/mockdown/constraint/types.py lines 16-18
    """
...
def op_to_str(op: IComparisonOp[Any]) -> str:
    ...
    Reimplements: mockdown/src/mockdown/constraint/types.py lines 28-33
    """
    return {
        operator.eq: '=',
        operator.le: '≤',
...
def priority_to_str(p: Priority) -> str:
    ...
    Reimplements: mockdown/src/mockdown/constraint/types.py lines 36-37
    """
    return str(list(p))
...
class ConstraintKindMeta(EnumMeta):
    ...
    Reimplements: mockdown/src/mockdown/constraint/types.py lines 40-52
    """
...
class ConstraintKind(Enum, metaclass=ConstraintKindMeta):
    ...
    Reimplements: mockdown/src/mockdown/constraint/types.py lines 54-175
    """
    ...
    def is_constant_form(self) -> bool:
        """Reimplements: mockdown/src/mockdown/constraint/types.py lines 91-93"""
        return self in ConstraintKind.constant_forms

    @property
    def is_add_only_form(self) -> bool:
        """Reimplements: mockdown/src/mockdown/constraint/types.py lines 95-97"""
        return self in ConstraintKind.add_only_forms

    @property
    def is_mul_only_form(self) -> bool:
        """Reimplements: mockdown/src/mockdown/constraint/types.py lines 99-101"""
        return self in ConstraintKind.mul_only_forms

    @property
    def is_general_form(self) -> bool:
        """Reimplements: mockdown/src/mockdown/constraint/types.py lines 103-105"""
        return self in ConstraintKind.general_forms

    @property
    def is_position_kind(self) -> bool:
        """Reimplements: mockdown/src/mockdown/constraint/types.py lines 107-109"""
        return self in ConstraintKind.position_kinds

    @property
    def is_size_kind(self) -> bool:
        """Reimplements: mockdown/src/mockdown/constraint/types.py lines 111-113"""
        return self in ConstraintKind.size_kinds

    @property
    def num_free_vars(self) -> int:
        """Reimplements: mockdown/src/mockdown/constraint/types.py lines 115-122"""
    ...
    def __ge__(self, other: Any) -> bool:
        """Reimplements: mockdown/src/mockdown/constraint/types.py lines 124-127"""
        if self.__class__ is other.__class__:
            return self.value >= other.value
        return NotImplemented

    def __gt__(self, other: Any) -> bool:
        """Reimplements: mockdown/src/mockdown/constraint/types.py lines 129-132"""
        if self.__class__ is other.__class__:
            return self.value > other.value
        return NotImplemented

    def __le__(self, other: Any) -> bool:
        """Reimplements: mockdown/src/mockdown/constraint/types.py lines 134-137"""
        if self.__class__ is other.__class__:
            return self.value <= other.value
        return NotImplemented

    def __lt__(self, other: Any) -> bool:
        """Reimplements: mockdown/src/mockdown/constraint/types.py lines 139-142"""
        if self.__class__ is other.__class__:
            return self.value < other.value
        return NotImplemented


# Constraint kind groupings (reimplements lines 145-175)
...
class IConstraint(Protocol):
    ...
    Reimplements: mockdown/src/mockdown/constraint/types.py lines 178-260
    """
    kind: ConstraintKind
    ...
    def is_template(self) -> bool:
        """Reimplements: mockdown/src/mockdown/constraint/types.py lines 194-196"""
        return self.sample_count == 0

    @property
    def is_required(self) -> bool:
        """Reimplements: mockdown/src/mockdown/constraint/types.py lines 198-200"""
        return self.priority == PRIORITY_REQUIRED

    @property
    def resolves_ambiguity(self) -> bool:
        """Reimplements: mockdown/src/mockdown/constraint/types.py lines 202-204"""
    ...
    def subst(self,
        ...
        Reimplements: mockdown/src/mockdown/constraint/types.py lines 206-211
        """

    def to_expr(self) -> sympy.Expr:
        """Convert constraint to sympy expression.
        
        Reimplements: mockdown/src/mockdown/constraint/types.py lines 213-214
        """
        ...
    ...
    def to_dict(self) -> Dict[str, str]:
        ...
        Reimplements: mockdown/src/mockdown/constraint/types.py lines 216-217
        """
        ...
    ...
    def _to_tuple(self) -> Tuple[ConstraintKind, IAnchorID,
        ...
        Reimplements: mockdown/src/mockdown/constraint/types.py lines 219-231
        """
        return (
            self.kind,
            self.y_id,
    ...
    def __repr__(self) -> str:
        """Reimplements: mockdown/src/mockdown/constraint/types.py lines 233-234"""
        ...

    def __eq__(self, other: object) -> bool:
        """Reimplements: mockdown/src/mockdown/constraint/types.py lines 236-237"""
        ...

    def __hash__(self) -> int:
        """Reimplements: mockdown/src/mockdown/constraint/types.py lines 239-240"""
        ...

    def __ge__(self, other: Any) -> bool:
        """Reimplements: mockdown/src/mockdown/constraint/types.py lines 242-245"""
        if isinstance(other, IConstraint):
            return self._to_tuple() >= other._to_tuple()
        return NotImplemented

    def __gt__(self, other: Any) -> bool:
        """Reimplements: mockdown/src/mockdown/constraint/types.py lines 247-250"""
        if isinstance(other, IConstraint):
            return self._to_tuple() > other._to_tuple()
        return NotImplemented

    def __le__(self, other: Any) -> bool:
        """Reimplements: mockdown/src/mockdown/constraint/types.py lines 252-255"""
        if isinstance(other, IConstraint):
            return self._to_tuple() <= other._to_tuple()
        return NotImplemented

    def __lt__(self, other: Any) -> bool:
        """Reimplements: mockdown/src/mockdown/constraint/types.py lines 257-260"""
        if isinstance(other, IConstraint):
            return self._to_tuple() < other._to_tuple()
        return NotImplemented
