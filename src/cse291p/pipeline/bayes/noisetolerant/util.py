"""Utility helpers for noise-tolerant learning.

Reimplements:
- mockdown/src/mockdown/learning/noisetolerant/util.py (entire file)
"""
...
def q2cf(a: int, b: int) -> Iterator[int]:
    """Yields continued fraction expansion of a/b."""
    while b:
...
def sb_depth(a: int, b: int) -> int:
    """Stern-Brocot depth of the rational a/b."""
...
"""Utility functions for noise-tolerant learning."""

# Placeholder for learning utilities
